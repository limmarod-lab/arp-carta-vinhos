...
Edição de vinho, categoria ou evento só publica se o login admin estiver válido. Se o JSONBin recusar, a interface mostra o erro real. Depois de publicar, os outros aparelhos precisam de refresh.
